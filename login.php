    ...
    <section class="member-page">
      <div class="container">
        ...
        <form method="POST" action="user_action.php" class="needs-validation" validate>
          ...
          <p class="text-center mb-0"> <a href="registration.php">Click here for user registration</a></p>
          <br>
          <p class="text-center mb-0"> <a href="https://bootstrapmade.com/members/lostpassword/">Lost your password?</a></p>
        </form>
      </div>
    </section>
