...
session_start();
$works_list = $work_obj->display_works();
$category_list = $work_obj->list_categories();

if (isset($_GET['saerch'])) {
  $saerch_word = $_GET['saerch'];
  $works_list = $work_obj->search_works($saerch_word);
}
// echo "<pre>";
// print_r($works_list);
// echo "</pre>";
...
<body>
  ...
  if (isset($_SESSION['user_id'])) {
    ...
    echo '<header id="header" class="fixed-top header-transparent">';
  }
  ?>
  ...
  if (isset($_SESSION['user_id'])) {
    ...
    echo '<section id="hero">
              <div class="hero-container" data-aos="fade-up">
                <h1>Welcome to NicePort</h1>
                <h2>You can share yor favorite works no matter what genre in this site.</h2>
                <a href="login.php"" class=" btn-get-started"><i class="fas fa-sign-in-alt"></i></a>
              </div>
  ...
  <section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <div class="section-title" data-aos="fade-in" data-aos-delay="100">
        <h2>List of posts</h2>
        <p>you can comment or press the Nice on uploaded reviews</p>
      </div>
      ...
      <div class="row portfolio-container" data-aos="fade-up">
        <?php if ($works_list !== FALSE) : ?>
          <?php foreach ($works_list as $row) : ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo $row['category_name'] ?>">
              <div class="portfolio-wrap">
                ...
                echo "<img src='$src' class='img-fluid' alt=''>";
                ?>
                <div class="portfolio-links">
                  ...
                  echo "<a href='$src' class='portfolio-lightbox' title='$title'><i class='bx bx-plus'></i></a>";
                  ?>
                  <a href="work_detail.php?work_id=<?php echo $row['work_id'] ?>" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          <?php endforeach ?>
        <?php else : ?>
          <h1 class="text-center">works not found</h1>
        <?php endif; ?>
